...
const SoftButton = ({ children, className = "", ...props }: any) => (
  <button
    className={
        ...
        <div className="flex flex-col justify-center space-y-8 pr-2">
          <div>
            ...
            <p className="mt-4 max-w-md text-slate-600">
              Join over a million people who choose <span className="font-medium text-slate-900">moneyflow</span> for
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-between">
              ...
              <motion.div
                ...
                animate={{
                  boxShadow: ["0 0 0 0 rgba(16,185,129,0.35)", "0 0 0 16px rgba(16,185,129,0)"],
                }}
          ...
          >
            ...
            <div className="mt-2 text-3xl font-semibold tracking-tight">
              $50,240 <span className="text-sm font-medium text-slate-400 align-middle">USD</span>
            </div>
